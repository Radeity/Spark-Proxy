...
public class Worker {
    ...
    public static void run(String dispatcherHost, String executorId) {
        ...
        WorkerEndPoint workerEndPoint = new WorkerEndPoint(executorRpcEnv, executorConf, dispatcherHost, executorId);
